namespace Loupedeck.PCMonitorPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.PCMonitorPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.PCMonitorPlugin.Resources.Resource.txt`.
